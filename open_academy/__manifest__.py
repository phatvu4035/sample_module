# -*- coding: utf-8 -*-
{
    ...
    'assets':{
        'web.assets_qweb': [
            'open_academy/static/src/views/open_academy/open_academy_renderer.xml',
            'open_academy/static/src/views/open_academy/open_academy_view.xml',
        ],
        'web.assets_backend': [
            'open_academy/static/src/views/open_academy/open_academy_arch_parser.js',
            'open_academy/static/src/views/open_academy/open_academy_model.js',
            'open_academy/static/src/views/open_academy/open_academy_renderer.js',
            'open_academy/static/src/views/open_academy/open_academy_view.js',
        ],
    },
